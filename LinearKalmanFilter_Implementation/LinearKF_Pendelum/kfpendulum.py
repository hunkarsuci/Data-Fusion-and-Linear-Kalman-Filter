...
try:
    # Works when imported as part of the LinearKF_Pendelum package.
    from .pendulum import PendulumModel
except ImportError:
    # Works when assignment2_filter.py is launched directly.
    from pendulum import PendulumModel
...
def run_sim(KalmanFilterModel, sim_option, kf_options):
    ...
    if draw_animation is True:
        ...
        def update_plot(i):
            ...
            return mass_plot, arm_plot, est_mass_plot, est_arm_plot
