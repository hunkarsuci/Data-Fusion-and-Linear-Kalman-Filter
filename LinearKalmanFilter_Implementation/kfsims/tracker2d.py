...
def run_sim(KalmanFilterModel, sim_option, kf_options):
    ...
    if draw_animation is True:
        ...
        def update_plot(i):
            # Plot Vehicle
            # Matplotlib Line2D.set_data() requires x and y sequences,
            # even when plotting a single point.
            vehicle_plot.set_data([vehicle_position_history[i][0]],
                                  [vehicle_position_history[i][1]])
